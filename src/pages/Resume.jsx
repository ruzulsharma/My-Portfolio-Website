  ...
  return (
    ...
    <div className="font-sans text-white space-y-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Worked as a Backend sub-ordinate with Java Spring Boot, Postman, MongoDB, Apache POI for Excel, and various libraries</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Built a book management system with CRUD features using JDBC, JPA, Hibernate</li>
      ...
      >
        ...
        <FloatingSkill
          skills={[
            "JAVA 8", "Spring Boot", "Hibernate", "HTML", "CSS",
            "Tailwind CSS", "JavaScript", "React", "Node.js", "MySQL",
            "MongoDB", "Firebase", "Oracle", "Git", "Postman",
            "Bootstrap", "VS Code", "IntelliJ", "AWS (Basic)",
          ]}
        />
      </motion.section>
    </div>
